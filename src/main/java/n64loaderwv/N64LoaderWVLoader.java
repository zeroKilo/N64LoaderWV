...
public class N64LoaderWVLoader extends AbstractLibrarySupportLoader {
	...
	public void MakeBlock(Program program, String name, String desc, int address, InputStream s, int size,
		...
		try {
			...
			memoryBlockUtil.createInitializedBlock(name, addr, s, size, desc, null, bf[0] == '1',
					bf[1] == '1', bf[2] == '1', monitor);


			if (struc != null)
				DataUtilities.createData(program, addr, struc, -1, false,
	...
	protected void load(ByteProvider provider, LoadSpec loadSpec, List<Option> options, Program program,
						MemoryConflictHandler memoryConflictHandler, TaskMonitor monitor, MessageLog log) throws CancelledException, IOException {
		...
		MemoryBlockUtil memoryBlockUtil = new MemoryBlockUtil(program, memoryConflictHandler);
